...
export default function Agents() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Step 3: DNS resolver (optional) */}
      <SectionCard title="3. DNS monitoring (optional)" description="For whole-home DNS visibility, run the resolver and point your router / devices' DNS at this host.">
        <div className="space-y-3 p-5">
          <CopyBlock text={resolverCmd} />
          <p className="text-xs text-slate-500">Then set the host's IP as the DNS server on the devices you want to monitor. Every domain they look up flows into HomeSIEM.</p>
        </div>
      </SectionCard>
